...
public class CustomAdapter extends BaseAdapter {
    ...
    public CustomAdapter(List<ChatModel> list_chat_models, Context context, LayoutInflater layoutInflater) {
    ...
    public CustomAdapter(List<ChatModel> models, Context applicationContext) {
    }
